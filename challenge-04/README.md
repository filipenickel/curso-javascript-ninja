...
carro.obterMarcaModelo = function(){
    return 'Esse carro é um '+ carro.obterModelo() + ' ' + carro.obterModelo();
  }
...
*/
carro.adicionarPessoasCarro = function(addPessoaCarro){
 
  carro.quantidadePessoas == carro.assentos ? return "O carro já está lotado!";
  
  var espacoDisponivel = carro.quantidadePessoas - carro.assentos;
  
    if(espacoDisponivel < addPessoaCarro){
      if(espacoDisponivel == 1){
        return "Só cabem mais '+ espacoDisponivel + 'pessoa!'
      }
        return "Só cabem mais '+ espacoDisponivel + 'pessoas!'
      }
